...
public class ProductSaxHandlerWithProcessor extends DefaultHandler {
    private static final Logger LOG = LoggerFactory.getLogger(ProductSaxHandlerWithProcessor.class);
    ...
    public ProductSaxHandlerWithProcessor(ProductProcessor processor) {
        super();
